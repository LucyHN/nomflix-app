...
import { isThrowStatement, moveEmitHelpers, setSyntheticLeadingComments } from "typescript";
...
const Banner = styled.div<{bgPhoto:string}>`
    ...
    justify-content: center;
    padding: 60px;
    background-image: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.3)), url(${(props) => props.bgPhoto});
